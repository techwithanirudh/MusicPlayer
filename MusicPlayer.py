...
def about_us():
    tkinter.messagebox.showinfo('About AniMusic', 'This is a music media_player built using Python Tkinter by @anirudhS')
...
root.title("AniMusic")
root.iconbitmap(r'images/AniMusic.ico')
